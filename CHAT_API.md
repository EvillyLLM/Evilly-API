...
The Chat API allows you to have natural conversations with Evilly AI assistant.

## Endpoints

### POST /api/chat

Send a message to Evilly and receive a conversational response with context awareness.
...
|-----------|------|----------|-------------|
| message | string | Yes | The user's message to send to Evilly |
...
```json
{
  "response": "I'm Evilly, a friendly and intelligent AI companion created by talented developers who wanted to make AI assistance more personal and friendly. I'm here to help you with various tasks, answer questions, or just have a nice conversation!",
  "usage": {
    "prompt_tokens": 45,
...
|-------|------|-------------|
| response | string | Evilly's response message |
...
Evilly uses the following personality traits:
...
```javascript
const response = await fetch('https://evilly.onrender.com/api/chat', {
  method: 'POST',
...
- **Website:** [https://evilly.xyz](https://evilly.xyz)
- **GitHub:** [https://github.com/EvillyLLM/Evilly-API](https://github.com/EvillyLLM/Evilly-API)
- **Twitter:** [https://x.com/EvillyLLM](https://x.com/EvillyLLM)
