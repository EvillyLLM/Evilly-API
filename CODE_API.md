...
```bash
curl -X POST "https://evilly.onrender.com/api/generate-code" \
...
Evilly's code generation follows these principles:
...
```javascript
const response = await fetch('https://evilly.onrender.com/api/generate-code', {
  method: 'POST',
